...
const T1 = () => {
    return (
        ...
        <Hero image={heroImage} title="Modern Design" text="interior design studio" fontFamily='Playfair Display' button='true' textButtonColor='white' backgroundColorButton='transparent' style={{textAlign:'center', color:'white'}}/>
